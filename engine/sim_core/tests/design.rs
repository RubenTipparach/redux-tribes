...
fn every_authored_class_derives_exactly_as_the_editor_does() {
    let cases: &[(ShipClassId, &[usize], Geometry, Expect)] = &[
        ...
        (ShipClassId::TerranCarrier,
         &[5, 5, 5, 5, 0, 0, 0, 0, 12, 13, 12, 13, 12, 13, 12, 13, 12, 14, 12, 14, 7, 7, 7, 7, 10, 10, 10, 10, 11, 11, 11, 11, 16, 20, 20, 20, 20, 20, 20, 17, 17, 17, 17, 17, 17, 17, 17, 18, 18, 18, 18, 22, 22, 22, 19, 19, 19, 19, 19, 19],
         Geometry { plate_cells: 5955, ext: [31, 19, 57], radius_cells: 30.475399915341555, fouled: 0 },
         Expect { mass: 32.07500076293945, hull: 13452.3203125, radius: 13.332986831665039, accel_fwd: 0.0810600146651268, accel_retro: 0.01870615780353546, accel_lat: 0.012470771558582783, max_speed: 7.0, yaw: 0.363183856010437, pitch: 0.24333320558071136, reach_u: 4.0530009269714355, marines: 40, capacity: 8, boarding_range: 40.0, legal: true }),
