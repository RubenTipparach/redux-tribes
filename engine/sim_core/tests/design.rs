...
fn every_authored_class_derives_exactly_as_the_editor_does() {
    let cases: &[(ShipClassId, &[usize], Geometry, Expect)] = &[
        ...
        (ShipClassId::TerranCarrier,
         &[5, 5, 5, 5, 0, 0, 0, 0, 12, 13, 12, 13, 12, 13, 12, 13, 12, 14, 12, 14, 7, 7, 7, 7, 10, 10, 10, 10, 11, 11, 11, 11, 16, 17, 17, 17, 17, 17, 17, 17, 17, 20, 20, 20, 20, 20, 20, 18, 18, 18, 18, 22, 22, 24, 19, 19, 19, 19, 19, 19],
         Geometry { plate_cells: 6419, ext: [31, 19, 58], radius_cells: 31.29696470905765, fouled: 0 },
         Expect { mass: 34.509849548339844, hull: 14486.9443359375, radius: 13.692421913146973, accel_fwd: 0.07534081488847733, accel_retro: 0.017386341467499733, accel_lat: 0.011590894311666489, max_speed: 7.0, yaw: 0.3317393660545349, pitch: 0.22226539254188538, reach_u: 3.767040729522705, marines: 40, capacity: 8, boarding_range: 40.0, legal: true }),
