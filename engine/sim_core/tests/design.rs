...
fn every_authored_class_derives_exactly_as_the_editor_does() {
    let cases: &[(ShipClassId, &[usize], Geometry, Expect)] = &[
        ...
        (ShipClassId::TerranCarrier,
         ...
         Geometry { plate_cells: 5980, ext: [31, 19, 57], radius_cells: 30.475399915341555, fouled: 0 },
         Expect { mass: 32.318359375, hull: 13531.6796875, radius: 13.332986831665039, accel_fwd: 0.08044962584972382, accel_retro: 0.01856529898941517, accel_lat: 0.01237686537206173, max_speed: 7.0, yaw: 0.36044907569885254, pitch: 0.24150089919567108, reach_u: 4.022481441497803, marines: 40, capacity: 8, boarding_range: 40.0, legal: true }),
