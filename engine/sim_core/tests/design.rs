...
fn every_authored_class_derives_exactly_as_the_editor_does() {
    let cases: &[(ShipClassId, &[usize], Geometry, Expect)] = &[
        ...
        (ShipClassId::TerranDestroyer,
         ...
         Expect { mass: 2.216862916946411, hull: 787.677978515625, radius: 5.089905261993408, accel_fwd: 0.8796213269233704, accel_retro: 0.270652711391449, accel_lat: 0.1804351508617401, max_speed: 7.0, yaw: 5.2547783851623535, pitch: 3.5207016468048096, reach_u: 42.1471061706543, marines: 25, capacity: 10, boarding_range: 20.0, legal: true }),
        ...
        (ShipClassId::RogueDestroyer,
         ...
         Expect { mass: 1.254304051399231, hull: 373.1109924316406, radius: 4.151299953460693, accel_fwd: 0.7892823219299316, accel_retro: 0.47835293412208557, accel_lat: 0.22323137521743774, max_speed: 9.5, yaw: 7.5625319480896, pitch: 5.066896438598633, reach_u: 39.464115142822266, marines: 45, capacity: 14, boarding_range: 40.0, legal: true }),
        ...
        (ShipClassId::BenefactorDestroyer,
         ...
         Expect { mass: 2.0109970569610596, hull: 726.7169799804688, radius: 4.825920104980469, accel_fwd: 0.6464455127716064, accel_retro: 0.2983594834804535, accel_lat: 0.1989063173532486, max_speed: 7.0, yaw: 6.003354072570801, pitch: 4.022247791290283, reach_u: 32.3222770690918, marines: 25, capacity: 10, boarding_range: 20.0, legal: true }),
        ...
        (ShipClassId::CivilHauler,
         ...
         Expect { mass: 2.2394089698791504, hull: 785.6010131835938, radius: 4.740809917449951, accel_fwd: 0.4018917381763458, accel_retro: 0.2679278254508972, accel_lat: 0.1339639127254486, max_speed: 5.0, yaw: 4.118150234222412, pitch: 2.7591607570648193, reach_u: 20.094587326049805, marines: 10, capacity: 6, boarding_range: 20.0, legal: true }),
        ...
        (ShipClassId::CivilMiner,
         ...
         Expect { mass: 2.0693299770355225, hull: 684.8300170898438, radius: 4.125283241271973, accel_fwd: 0.2899489104747772, accel_retro: 0.2899489104747772, accel_lat: 0.1449744552373886, max_speed: 5.0, yaw: 5.013700485229492, pitch: 3.3591794967651367, reach_u: 14.497446060180664, marines: 10, capacity: 4, boarding_range: 20.0, legal: true }),
